...
function Build-Brain {
    ...
    # UWAGA: same DLL-ki runtime (cublas/cudart) leżą w podfolderze "bin\x64",
    # NIE bezpośrednio w "bin" -- tam jest tylko nvcc i inne narzędzia
    # budujące (sprawdzone przez "dir" na obu maszynach: FOX i ADMIN).
